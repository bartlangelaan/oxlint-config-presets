...
Generated with `@oxlint/migrate@1.64.0`.
...
<details>
<summary>200 rules successfully migrated</summary>
...
<details>
<summary>85 rules have no oxlint equivalent</summary>

**Not yet implemented in oxlint**

`no-implied-eval`, `no-unreachable-loop`, `no-restricted-syntax`, `one-var`, `prefer-arrow-callback`, `import/no-extraneous-dependencies`, `import/newline-after-import`, `import/no-useless-path-segments`, `import/no-import-module-exports`, `import/no-relative-packages`, `strict`
...
<details>
<summary>151 rules successfully migrated</summary>
...
`consistent-this`, `id-denylist`, `id-match`, `no-implicit-globals`, `no-implied-eval`, `no-restricted-syntax`, `no-unreachable-loop`, `one-var`, `prefer-arrow-callback`, `prefer-named-capture-group`, `require-atomic-updates`, `strict`
...
`no-unreachable-loop`, `require-atomic-updates`, `no-implied-eval`, `prefer-arrow-callback`, `strict`
...
<details>
<summary>164 rules successfully migrated</summary>
...
`jsdoc/check-alignment`, `jsdoc/check-param-names`, `jsdoc/check-types`, `jsdoc/check-values`, `jsdoc/escape-inline-tags`, `jsdoc/multiline-blocks`, `jsdoc/no-multi-asterisks`, `jsdoc/require-jsdoc`, `jsdoc/require-returns-check`, `jsdoc/require-yields-check`, `jsdoc/tag-lines`, `jsdoc/ts-no-empty-object-type`, `jsdoc/valid-types`, `jsdoc/check-syntax`, `jsdoc/check-values`, `jsdoc/no-bad-blocks`, `jsdoc/require-asterisk-prefix`, `jsdoc/require-description`, `jsdoc/require-hyphen-before-param-description`, `jsdoc/require-throws`, `jsdoc/tag-lines`, `jsdoc/check-alignment`, `jsdoc/check-param-names`, `jsdoc/check-types`, `jsdoc/multiline-blocks`, `jsdoc/no-multi-asterisks`, `jsdoc/require-jsdoc`, `jsdoc/require-returns-check`, `jsdoc/require-yields-check`, `jsdoc/valid-types`, `no-implied-eval`, `no-unreachable-loop`, `prefer-arrow-callback`, `strict`
...
<details>
<summary>173 rules successfully migrated</summary>
...
`no-implied-eval`, `no-unreachable-loop`, `one-var`, `prefer-arrow-callback`, `strict`
...
`react/no-deprecated`, `react/no-typos`, `react/no-unstable-nested-components`
...
`react/jsx-uses-react`, `react/jsx-uses-vars`, `react/prop-types`
...
`react/boolean-prop-naming`, `react/destructuring-assignment`, `react/function-component-definition`, `react/jsx-no-bind`, `react/jsx-no-leaked-render`, `react/jsx-no-literals`, `react/no-invalid-html-attribute`, `react/no-arrow-function-lifecycle`, `react/no-deprecated`, `react/no-typos`, `react/no-unstable-nested-components`, `react/no-object-type-as-default-prop`, `react/prefer-stateless-function`, `react/require-default-props`
...
`jsx-a11y/alt-text`, `jsx-a11y/anchor-ambiguous-text`, `jsx-a11y/anchor-has-content`, `jsx-a11y/anchor-is-valid`, `jsx-a11y/aria-activedescendant-has-tabindex`, `jsx-a11y/aria-props`, `jsx-a11y/aria-proptypes`, `jsx-a11y/aria-role`, `jsx-a11y/aria-unsupported-elements`, `jsx-a11y/autocomplete-valid`, `jsx-a11y/click-events-have-key-events`, `jsx-a11y/heading-has-content`, `jsx-a11y/html-has-lang`, `jsx-a11y/iframe-has-title`, `jsx-a11y/img-redundant-alt`, `jsx-a11y/interactive-supports-focus`, `jsx-a11y/label-has-associated-control`, `jsx-a11y/media-has-caption`, `jsx-a11y/mouse-events-have-key-events`, `jsx-a11y/no-access-key`, `jsx-a11y/no-autofocus`, `jsx-a11y/no-distracting-elements`, `jsx-a11y/no-noninteractive-element-to-interactive-role`, `jsx-a11y/no-noninteractive-tabindex`, `jsx-a11y/no-redundant-roles`, `jsx-a11y/no-static-element-interactions`, `jsx-a11y/role-has-required-aria-props`, `jsx-a11y/role-supports-aria-props`, `jsx-a11y/scope`, `jsx-a11y/tabindex-no-positive`
...
`jsx-a11y/no-interactive-element-to-noninteractive-role`, `jsx-a11y/no-noninteractive-element-interactions`
