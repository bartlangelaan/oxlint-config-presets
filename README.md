...
<details>
<summary>52 rules have no oxlint equivalent</summary>

**Not yet implemented in oxlint**

`jsdoc/check-param-names`, `jsdoc/no-blank-blocks`, `jsdoc/no-blank-block-descriptions`, `jsdoc/no-multi-asterisks`, `jsdoc/require-asterisk-prefix`, `jsdoc/tag-lines`, `no-implicit-globals`, `no-underscore-dangle`, `no-unreachable-loop`, `prefer-regex-literals`
