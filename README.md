...
<details>
<summary>292 rules successfully migrated</summary>
...
<details>
<summary>2 rules migrated without options (incompatible schema)</summary>
...
`import/no-cycle`, `react/jsx-no-duplicate-props`

</details>

<details>
<summary>115 rules have no oxlint equivalent</summary>

**Not yet implemented in oxlint**

`no-restricted-syntax`, `import/no-extraneous-dependencies`, `import/no-useless-path-segments`, `import/no-import-module-exports`, `import/no-relative-packages`, `strict`, `react/jsx-no-bind`, `react/no-typos`, `react/destructuring-assignment`, `react/no-arrow-function-lifecycle`, `react/no-invalid-html-attribute`
...
<details>
<summary>209 rules successfully migrated</summary>
...
<details>
<summary>80 rules have no oxlint equivalent</summary>

**Not yet implemented in oxlint**

`no-restricted-syntax`, `import/no-extraneous-dependencies`, `import/no-useless-path-segments`, `import/no-import-module-exports`, `import/no-relative-packages`, `strict`
...
<details>
<summary>158 rules successfully migrated</summary>
...
<details>
<summary>67 rules have no oxlint equivalent</summary>

**Not yet implemented in oxlint**

`no-restricted-syntax`, `strict`
...
<details>
<summary>180 rules have no oxlint equivalent</summary>

**Not yet implemented in oxlint**

`no-restricted-syntax`, `import/no-extraneous-dependencies`, `import/no-useless-path-segments`, `import/no-import-module-exports`, `import/no-relative-packages`, `strict`, `react/jsx-no-bind`, `react/no-typos`, `react/destructuring-assignment`, `react/no-arrow-function-lifecycle`, `react/no-invalid-html-attribute`, `react/jsx-no-bind`, `react/no-typos`, `react/destructuring-assignment`, `react/no-arrow-function-lifecycle`, `react/no-invalid-html-attribute`, `strict`, `import/no-extraneous-dependencies`, `import/no-useless-path-segments`, `import/no-import-module-exports`, `import/no-relative-packages`, `no-restricted-syntax`
...
<details>
<summary>57 rules have no oxlint equivalent</summary>

**Not yet implemented in oxlint**

`n/no-callback-literal`, `n/no-deprecated-api`, `n/process-exit-as-throw`
...
<details>
<summary>188 rules successfully migrated</summary>
...
`consistent-this`, `no-restricted-syntax`, `require-atomic-updates`, `strict`
...
`consistent-this`, `strict`, `require-atomic-updates`, `import/no-relative-packages`, `import/no-import-module-exports`, `import/no-useless-path-segments`, `import/no-unused-modules`, `import/no-extraneous-dependencies`, `unicorn/no-unused-properties`, `unicorn/consistent-destructuring`, `unicorn/prefer-switch`, `unicorn/no-unnecessary-polyfills`, `unicorn/import-index`
...
<details>
<summary>172 rules successfully migrated</summary>
...
<details>
<summary>181 rules successfully migrated</summary>
...
`no-restricted-syntax`, `node/no-deprecated-api`, `node/prefer-global/buffer`, `node/prefer-global/process`, `node/process-exit-as-throw`, `jsdoc/check-param-names`, `jsdoc/check-types`, `jsdoc/no-multi-asterisks`, `jsdoc/require-returns-check`, `jsdoc/require-yields-check`, `jsdoc/check-alignment`, `jsdoc/multiline-blocks`
...
<details>
<summary>4 migration warnings</summary>
...
`unicorn/consistent-class-member-order`, `unicorn/no-accidental-bitwise-operator`, `unicorn/no-barrel-files`, `unicorn/no-boolean-sort-comparator`, `unicorn/no-chained-comparison`, `unicorn/no-collection-bracket-access`, `unicorn/no-constant-zero-expression`, `unicorn/no-double-comparison`, `unicorn/no-for-loop`, `unicorn/no-invalid-argument-count`, `unicorn/no-invalid-character-comparison`, `unicorn/no-misrefactored-assignment`, `unicorn/no-missing-local-resource`, `unicorn/no-named-default`, `unicorn/no-non-function-verb-prefix`, `unicorn/no-nonstandard-builtin-properties`, `unicorn/no-shorthand-property-overrides`, `unicorn/no-transition-all`, `unicorn/no-undeclared-class-members`, `unicorn/no-unnecessary-boolean-comparison`, `unicorn/no-unsafe-promise-all-settled-values`, `unicorn/no-useless-coercion`, `unicorn/no-useless-concat`, `unicorn/no-useless-template-literals`, `unicorn/prefer-math-constants`, `unicorn/require-array-sort-compare`, `unicorn/require-frontmatter-fields`, `unicorn/require-proxy-trap-boolean-return`, `unicorn/template-indent`
