...
Generated with `@oxlint/migrate@1.67.0`.
...
`consistent-this`, `id-denylist`, `no-restricted-syntax`, `no-unreachable-loop`, `one-var`, `prefer-named-capture-group`, `require-atomic-updates`, `strict`
...
<details>
<summary>297 rules successfully migrated</summary>
...
<details>
<summary>177 rules successfully migrated</summary>
...
`@typescript-eslint/member-ordering`, `@typescript-eslint/method-signature-style`
...
`jsdoc/check-access`, `jsdoc/check-property-names`, `jsdoc/check-tag-names`, `jsdoc/empty-tags`, `jsdoc/implements-on-classes`, `jsdoc/no-defaults`, `jsdoc/require-param`, `jsdoc/require-param-description`, `jsdoc/require-param-name`, `jsdoc/require-param-type`, `jsdoc/require-property`, `jsdoc/require-property-description`, `jsdoc/require-property-name`, `jsdoc/require-property-type`, `jsdoc/require-returns`, `jsdoc/require-returns-description`, `jsdoc/require-returns-type`, `jsdoc/require-throws-description`, `jsdoc/require-throws-type`, `jsdoc/require-yields`, `jsdoc/require-yields-type`
...
`vue/no-arrow-functions-in-watch`, `vue/no-computed-properties-in-data`, `vue/no-export-in-script-setup`, `vue/no-shared-component-data`, `vue/require-render-return`, `vue/return-in-computed-property`, `vue/return-in-emits-validator`, `vue/valid-define-emits`, `vue/valid-define-props`, `vue/valid-next-tick`

</details>

<details>
<summary>48 rules have no oxlint equivalent</summary>
