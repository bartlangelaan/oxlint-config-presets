...
Generated with `@oxlint/migrate@1.65.0`.
...
<details>
<summary>121 rules have no oxlint equivalent</summary>

**Not yet implemented in oxlint**

`no-implied-eval`, `no-unreachable-loop`, `no-restricted-syntax`, `one-var`, `import/no-extraneous-dependencies`, `import/newline-after-import`, `import/no-useless-path-segments`, `import/no-import-module-exports`, `import/no-relative-packages`, `strict`, `react/jsx-no-bind`, `react/prefer-stateless-function`, `react/require-default-props`, `react/no-typos`, `react/destructuring-assignment`, `react/function-component-definition`, `react/no-unstable-nested-components`, `react/no-arrow-function-lifecycle`, `react/no-invalid-html-attribute`
...
<details>
<summary>202 rules successfully migrated</summary>
...
<details>
<summary>84 rules have no oxlint equivalent</summary>

**Not yet implemented in oxlint**

`no-implied-eval`, `no-unreachable-loop`, `no-restricted-syntax`, `one-var`, `import/no-extraneous-dependencies`, `import/newline-after-import`, `import/no-useless-path-segments`, `import/no-import-module-exports`, `import/no-relative-packages`, `strict`
...
<details>
<summary>152 rules successfully migrated</summary>
...
`no-implied-eval`, `no-unreachable-loop`, `no-restricted-syntax`, `one-var`, `strict`
...
`no-implied-eval`, `no-unreachable-loop`, `no-restricted-syntax`, `one-var`, `import/no-extraneous-dependencies`, `import/newline-after-import`, `import/no-useless-path-segments`, `import/no-import-module-exports`, `import/no-relative-packages`, `strict`, `react/jsx-no-bind`, `react/prefer-stateless-function`, `react/require-default-props`, `react/no-typos`, `react/destructuring-assignment`, `react/function-component-definition`, `react/no-unstable-nested-components`, `react/no-arrow-function-lifecycle`, `react/no-invalid-html-attribute`, `react/jsx-no-bind`, `react/prefer-stateless-function`, `react/require-default-props`, `react/no-typos`, `react/destructuring-assignment`, `react/function-component-definition`, `react/no-unstable-nested-components`, `react/no-arrow-function-lifecycle`, `react/no-invalid-html-attribute`, `strict`, `import/no-extraneous-dependencies`, `import/no-useless-path-segments`, `import/no-import-module-exports`, `import/no-relative-packages`, `no-restricted-syntax`, `one-var`, `no-unreachable-loop`, `no-implied-eval`
...
<details>
<summary>101 rules successfully migrated</summary>
...
`no-implied-eval`, `no-unreachable-loop`, `one-var`, `n/no-callback-literal`, `n/no-deprecated-api`, `n/process-exit-as-throw`
...
`consistent-this`, `id-denylist`, `id-match`, `no-implied-eval`, `no-restricted-syntax`, `no-unreachable-loop`, `one-var`, `prefer-named-capture-group`, `require-atomic-updates`, `strict`
...
<details>
<summary>111 rules successfully migrated</summary>
...
`no-unreachable-loop`, `require-atomic-updates`, `no-implied-eval`, `strict`
...
<details>
<summary>295 rules successfully migrated</summary>
...
<details>
<summary>168 rules successfully migrated</summary>
...
`jsdoc/check-alignment`, `jsdoc/check-param-names`, `jsdoc/check-types`, `jsdoc/check-values`, `jsdoc/escape-inline-tags`, `jsdoc/multiline-blocks`, `jsdoc/no-multi-asterisks`, `jsdoc/require-jsdoc`, `jsdoc/require-returns-check`, `jsdoc/require-yields-check`, `jsdoc/tag-lines`, `jsdoc/ts-no-empty-object-type`, `jsdoc/valid-types`, `jsdoc/check-syntax`, `jsdoc/check-values`, `jsdoc/no-bad-blocks`, `jsdoc/require-asterisk-prefix`, `jsdoc/require-description`, `jsdoc/require-hyphen-before-param-description`, `jsdoc/require-throws`, `jsdoc/tag-lines`, `jsdoc/check-alignment`, `jsdoc/check-param-names`, `jsdoc/check-types`, `jsdoc/multiline-blocks`, `jsdoc/no-multi-asterisks`, `jsdoc/require-jsdoc`, `jsdoc/require-returns-check`, `jsdoc/require-yields-check`, `jsdoc/valid-types`, `no-implied-eval`, `no-unreachable-loop`, `strict`
...
`no-implied-eval`, `no-unreachable-loop`, `one-var`, `strict`
...
`react/no-typos`, `react/no-unstable-nested-components`
...
`react/boolean-prop-naming`, `react/destructuring-assignment`, `react/function-component-definition`, `react/jsx-no-bind`, `react/jsx-no-leaked-render`, `react/jsx-no-literals`, `react/no-invalid-html-attribute`, `react/no-arrow-function-lifecycle`, `react/no-typos`, `react/no-unstable-nested-components`, `react/no-object-type-as-default-prop`, `react/prefer-stateless-function`, `react/require-default-props`
...
`vitest/padding-around-after-all-blocks`, `vitest/padding-around-after-each-blocks`, `vitest/padding-around-all`, `vitest/padding-around-before-all-blocks`, `vitest/padding-around-before-each-blocks`, `vitest/padding-around-describe-blocks`, `vitest/padding-around-expect-groups`, `vitest/padding-around-test-blocks`
