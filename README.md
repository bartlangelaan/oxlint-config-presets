...
Generated with `@oxlint/migrate@1.69.0`.
...
`capitalized-comments`, `import/no-cycle`, `jsx-a11y/anchor-has-content`, `react/jsx-no-duplicate-props`
...
<details>
<summary>205 rules successfully migrated</summary>
...
`capitalized-comments`, `import/no-cycle`
...
<details>
<summary>154 rules successfully migrated</summary>
...
`import/named`, `import/no-cycle`

</details>

<details>
<summary>360 rules have no oxlint equivalent</summary>
...
<details>
<summary>46 rules have no oxlint equivalent</summary>

**Not yet implemented in oxlint**

`react/boolean-prop-naming`, `react/destructuring-assignment`, `react/function-component-definition`, `react/jsx-no-bind`, `react/jsx-no-leaked-render`, `react/jsx-no-literals`, `react/no-invalid-html-attribute`, `react/no-arrow-function-lifecycle`, `react/no-typos`
...
`vue/component-definition-name-casing`, `vue/prop-name-casing`, `vue/require-prop-types`

</details>

<details>
<summary>22 rules have no oxlint equivalent</summary>

**Not yet implemented in oxlint**

`vue/one-component-per-file`, `vue/require-default-prop`
...
`vue/no-arrow-functions-in-watch`, `vue/no-computed-properties-in-data`, `vue/no-export-in-script-setup`, `vue/no-reserved-component-names`, `vue/no-reserved-keys`, `vue/no-reserved-props`, `vue/no-shared-component-data`, `vue/require-prop-type-constructor`, `vue/require-render-return`, `vue/return-in-computed-property`, `vue/return-in-emits-validator`, `vue/valid-define-emits`, `vue/valid-define-props`, `vue/valid-next-tick`
...
`vue/multi-word-component-names`, `vue/no-async-in-computed-properties`, `vue/no-dupe-keys`, `vue/no-mutating-props`, `vue/no-ref-as-operand`, `vue/no-side-effects-in-computed-properties`, `vue/no-use-computed-property-like-method`, `vue/require-valid-default-prop`
...
<details>
<summary>131 rules successfully migrated</summary>
...
`unicorn/expiring-todo-comments`, `unicorn/isolated-functions`, `unicorn/no-unnecessary-polyfills`, `unicorn/prefer-export-from`, `unicorn/prefer-simple-condition-first`, `unicorn/prefer-single-call`, `unicorn/prefer-switch`, `unicorn/prevent-abbreviations`
...
`unicorn/expiring-todo-comments`, `unicorn/no-unnecessary-polyfills`, `unicorn/prefer-simple-condition-first`, `unicorn/prefer-single-call`, `unicorn/prefer-switch`
